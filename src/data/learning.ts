...
const sampleTracks = [
  { slug: 'jvm', title: 'JVM from the inside out', type: 'Course', description: 'Build a mental model of the runtime, then follow memory from allocation to diagnosis.', note: 'Follow a guided sequence', lessons: [
    ...
    { slug: 'thread-local-handshakes', title: 'Thread-local handshakes', group: 'Threads and Synchronization', summary: 'A preview of how HotSpot coordinates with selected Java threads without requiring every thread to enter a global safepoint.', placeholder: true },
    { slug: 'platform-vs-virtual-threads', title: 'Platform threads vs virtual threads in JDK 25', group: 'Threads and Synchronization', summary: 'A preview of how Java platform threads map to operating-system threads, how virtual threads mount on carriers, and what that changes inside HotSpot.', placeholder: true },
    { slug: 'synchronization-internals', title: 'HotSpot synchronization internals', group: 'Threads and Synchronization', summary: 'A preview of lightweight locking, monitor contention, and mark-word behavior in JDK 25, connecting object headers to synchronization and virtual threads.', placeholder: true },
  ]},
